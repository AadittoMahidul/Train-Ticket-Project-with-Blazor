...
namespace TrainTicketProjectwithBlazor.Server.Controllers
{
    ...
    public class PassengersController : ControllerBase
    {
        ...
        public PassengersController(TrainDbContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("DTO")]
        public async Task<ActionResult<IEnumerable<PassengerDTO>>> GetPassengerDTOs()
        {
            if (_context.Passengers == null)
            {
                return NotFound();
            ...
            return await _context
                .Passengers.Include(x => x.Tickets)
                .Select(c => new PassengerDTO
                {
                    PassengerId = c.PassengerId,
                    PassengerName = c.PassengerName,
                    Address = c.Address,
                    Email = c.Email,
                    CanDelete = !c.Tickets.Any()
                })
                .ToListAsync();
        }
        ...
        public async Task<ActionResult<Passenger>> PostPassenger(Passenger passenger)
        {
          if (_context.Passengers == null)
          {
              return Problem("Entity set 'TrainDbContext.Passengers'  is null.");
          }
